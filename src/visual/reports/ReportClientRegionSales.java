...
// 4 - CLIENTE, REGIÃO OU CIDADE QUE MAIS COMPRARAM 
...
// GRAFICO TIPO SLIDING CATEGORY DATASET

public class ReportClientRegionSales extends JFrame {
    
    private List<Sale> sales;
    private XYDataset dataset;
    
    public ReportClientRegionSales(String applicationTitle, String chartTitle, List<Sale> sales) {
        ...
        plot.getRangeAxis().setRangeAboutValue(25, 25 / 5);
