...
-- Copiando dados para a tabela sevensales.itemssale: ~4 rows (aproximadamente)
DELETE FROM `itemssale`;
/*!40000 ALTER TABLE `itemssale` DISABLE KEYS */;
INSERT INTO `itemssale` (`Product_idProduct`, `Sale_idSale`, `Sale_User_idUser`, `Sale_Client_idClient`, `quantity`) VALUES
	(6, 1, 1, 3, 1),
	(8, 1, 1, 3, 2),
	(8, 2, 2, 2, 1),
	(8, 3, 1, 1, 1);
...
INSERT INTO `sale` (`idSale`, `date`, `type`, `period`, `discount`, `tax`, `netValue`, `User_idUser`, `Client_idClient`) VALUES
	(1, '2019-12-04 21:37:02', 'prazo', 3, 0, 10, NULL, 1, 3),
	(2, '2019-12-04 21:39:07', 'prazo', 6, NULL, 18, NULL, 2, 2),
	(3, '2019-12-04 21:39:26', 'vista', 1, 99, 0, NULL, 1, 1);
...
INSERT INTO `user` (`idUser`, `name`, `username`, `password`, `city`, `adress`, `cpf`, `rg`, `fu`, `email`, `contact`, `idAccess`) VALUES
	(1, 'Marcelo Leite Junior', 'mleitejunior', '1234', 'Machado', 'Nao tem', 151516, '', 'MG', 'mleitejunior@gmail.com', '35 99991234', 1),
	(2, 'Alexingeriu de Sushimoiama', 'shingeriu', 'japaloko', 'Hiroshima', 'Longe', 15651561, '', 'KO', 'omaea@shingeriu.nani', '12315161', 2);
